...
public abstract class BiomeMappings {
	...
	enum To19Mapping {
		...
		JUNGLE(Biome.JUNGLE),
		JUNGLE_HILLS(Biome.MUTATED_JUNGLE),
		...
		META_TAIGA_HILLS(Biome.REDWOOD_TAIGA_HILLS),
		...
		MESA_PLATEAU_FOREST_MOUNTAINS(Biome.MESA_ROCK),
		MESA_PLATEAU_MOUNTAINS(Biome.MESA_CLEAR_ROCK),
		BIRCH_FOREST_MOUNTAINS(Biome.MUTATED_BIRCH_FOREST),
		BIRCH_FOREST_HILLS_MOUNTAINS(Biome.MUTATED_BIRCH_FOREST_HILLS),
		ROOFED_FOREST_HILLS(Biome.MUTATED_ROOFED_FOREST),
